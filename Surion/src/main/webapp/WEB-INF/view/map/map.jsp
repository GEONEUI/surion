...
<head>
    ...
    <title>공간정보 오픈플랫폼 오픈API</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <title>2DMap</title>
    <script src="https://map.vworld.kr/js/map/OpenLayers-2.13/OpenLayers-2.13.js"></script>
    <script src="https://map.vworld.kr/js/apis.do?type=Base&apiKey=[FC2288DD-4F12-3146-84FC-447D2EA287C7]"></script>
...
<script type="text/javascript" src="http://map.vworld.kr/js/vworldMapInit.js.do?version=2.0&apiKey=[FC2288DD-4F12-3146-84FC-447D2EA287C7]"></script>
<script>
    vw.ol3.MapOptions = {
